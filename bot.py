...
def add_group(update: Update, context: CallbackContext):
    for member in update.message.new_chat_members:
        update.message.reply_text(f'Hello {member.full_name} ,  DÜNYA VARMIŞ!
Selamlar, ben Alper. Bu mesaj size "EkoHarita - SADECE ACİL ÇAĞRILAR - www.ekoharita.org" (https://t.me/ekoharita) grubuna katıldığınız için gönderiliyor.
